...
public class ListDamageActivity extends Activity {
  ListView list;
  ...
  public void gotoListEditor(View view) {
    Intent myIntent = new Intent(ListDamageActivity.this, ListEditorActivity.class);
