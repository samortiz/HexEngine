...
public class ListBgTypeActivity extends Activity {
  ListView list;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    String typeName = "Background Type";
  ...
  public void gotoListEditor(View view) {
    Intent myIntent = new Intent(ListBgTypeActivity.this, ListEditorActivity.class);
