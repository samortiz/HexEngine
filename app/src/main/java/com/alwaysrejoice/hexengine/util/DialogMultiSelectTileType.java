...
public class DialogMultiSelectTileType implements OnMultiChoiceClickListener, DialogInterface.OnClickListener {

  private Context context;
  private String title;
  private List<TileType> data;
  private List<TileType> selected; // Stores state both in and out
  ...
  public DialogMultiSelectTileType(Context context, String title, List<TileType> data, List<TileType> selected) {
  ...
  public void showDialog(DialogMultiSelectListener listener) {
    ...
    for (int i=0; i<data.size(); i++) {
      dataArray[i] = data.get(i).getName();
    }
